...
import { IImage, IVoice } from "../../models/IWord";
import { useUploadFileMutation } from "../../services/uploadService";
...
interface IUploadFile {
	...
	title: string;
	type: string;
	setValue: (e: string | undefined | any) => void;
}

export default function UploadFile({ defFile, title, type, setValue }: IUploadFile) {
	const [file, setFile] = useState<any>([]),
		...
		[uploadFile, { isLoading, isError }] = useUploadFileMutation();
	...
	const handleChange = (file: any) => {
		...
		uploadFile({ body: data, token: localStorage.getItem("token") }).then((res) => {
			if ("data" in res) setValue(res?.data?.data?._id);
			console.log(res);
		});
